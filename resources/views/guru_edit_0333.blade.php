      ...
      <div class="table-wrapper">
         ...
         <form method="POST" autocomplete="off">
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputAddress" name="inputTech" placeholder="Contoh: Ilmu Komputer" value="{{ $data->mengajar }}" required />
               </div>
            </div>
            <div class="form-group row">
